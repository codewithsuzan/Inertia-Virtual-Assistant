...
function speakThis(message) {
    ...
    if(message.includes('hey') || message.includes('hello')) {
    ...
    else if (message.includes('activate inertia')) {
        const finalText = "Activating Inertia  Going online"  + wishMe();
        speech.text = finalText;
    }
        ...
        const finalText = "You are my creator and my Boss.";
        speech.text = finalText;
    }
    ...
    else if(message.includes('open virtual studio code')) {
        ...
        const finalText = "see you later ! Take care and have a good break!";
        speech.text = finalText;
    }
